...
- [x] **1-3-3** batch_service 单元测试（T07）含 4 种类型规则违反用例 — 2026-05-14
- [x] **1-3-4** BatchList 前端列表页（T03）— 2026-05-14
- [x] **1-3-5** BatchForm 前端表单页（T04）含批次类型联动校验 — 2026-05-14
...
- [x] **3-2-2** purchase_order_service + Blueprint（T02）— 2026-05-17
